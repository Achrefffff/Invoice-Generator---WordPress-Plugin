...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['generate_invoice'])) {
    ...
    // Vérifiction des données nécessaires sont présentes
    if (!empty($client_name) && !empty($client_email) && !empty($amount) && !empty($currency) && isset($tva)) {
        // Générer la facture
        ...
        echo '<div class="notice notice-error is-dismissible"><p>Veuillez remplir tous les champs obligatoires.</p></div>';
    }
}
?>
